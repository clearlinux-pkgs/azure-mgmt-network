...
Source0  : https://files.pythonhosted.org/packages/3d/2c/fdfbbf4ef231ae3b1e38885d060fc31efa35af9a8c6305618bffb2274191/azure-mgmt-network-17.0.0.zip
Summary  : Microsoft Azure Network Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-network-python = %{version}-%{release}
Requires: azure-mgmt-network-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-network package.
Group: Default
Requires: azure-mgmt-network-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-network package.


%package python3
Summary: python3 components for the azure-mgmt-network package.
Group: Default
...
%description python3
python3 components for the azure-mgmt-network package.


%prep
%setup -q -n azure-mgmt-network-17.0.0
cd %{_builddir}/azure-mgmt-network-17.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047203
